 ...
 */
class Complex private constructor(val real: Double, val imag: Double = 0.0) :
    Number() {
    ...
    companion object {
        ...
        fun valueOf(real: Int, imag: Int = 0): Complex = Complex(real.toDouble(), imag.toDouble())
    ...
    override fun toDouble(): Double {
        if (!isReal) throw UnsupportedOperationException("cafetite.numerics.Complex with imaginary part has no double equivalent.")
        return this.real
    }
...
//
//        if (other is cafetite.numerics.Complex)
...
//    }
    ...
    override fun hashCode(): Int {
        ...
        // Round small differences to 12 digits for hash stability
        val r = (real * EPS).toLong()
        val i = if (isReal) 0L else (imag * EPS).toLong()
        return 31 * r.hashCode() + i.hashCode()
    }
